...
#ifndef PROCESS_SUPER_SUPER_H
#define PROCESS_SUPER_SUPER_H
...
class Super : public process::Process
{
public:
...
private:
    Super(int32_t num, const std::string& configDir, const std::string& logDir);
