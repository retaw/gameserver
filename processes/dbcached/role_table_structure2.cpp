# 1 "role_table_structure.cpp"
# 1 "/home/water/server/processes/dbcached//"
# 1 "<命令行>"
...
# 1 "/home/water/server/water/libs/mysql++/installed/include/mysql++/ssqls.h" 1
# 10 "/home/water/server/water/libs/mysql++/installed/include/mysql++/ssqls.h"
# 1 "/home/water/server/water/libs/mysql++/installed/include/mysql++/noexceptions.h" 1
# 41 "/home/water/server/water/libs/mysql++/installed/include/mysql++/noexceptions.h"
# 1 "/home/water/server/water/libs/mysql++/installed/include/mysql++/common.h" 1
# 131 "/home/water/server/water/libs/mysql++/installed/include/mysql++/common.h"
# 1 "/usr/local/mysql/include/mysql_version.h" 1
# 132 "/home/water/server/water/libs/mysql++/installed/include/mysql++/common.h" 2
...
# 158 "/home/water/server/water/libs/mysql++/installed/include/mysql++/common.h"
typedef unsigned long long ulonglong;
typedef long long longlong;
# 169 "/home/water/server/water/libs/mysql++/installed/include/mysql++/common.h"
typedef unsigned long ulong;


}
# 189 "/home/water/server/water/libs/mysql++/installed/include/mysql++/common.h"
# 1 "/usr/local/mysql/include/mysql.h" 1
# 42 "/usr/local/mysql/include/mysql.h"
extern "C" {
...
# 48 "/usr/local/mysql/include/mysql.h" 2




typedef char my_bool;
# 66 "/usr/local/mysql/include/mysql.h"
...
# 1 "/usr/local/mysql/include/mysql_version.h" 1
# 72 "/usr/local/mysql/include/mysql.h" 2
# 1 "/usr/local/mysql/include/mysql_com.h" 1
# 66 "/usr/local/mysql/include/mysql_com.h"
...
# 305 "/usr/local/mysql/include/mysql_com.h"
struct st_vio;
typedef struct st_vio Vio;
# 316 "/usr/local/mysql/include/mysql_com.h"
typedef struct st_net {
  ...
  my_bool compress;
  my_bool unused3;
# 346 "/usr/local/mysql/include/mysql_com.h"
  ...
  char sqlstate[5 +1];
# 363 "/usr/local/mysql/include/mysql_com.h"
  void *extension;
} NET;
...
# 434 "/usr/local/mysql/include/mysql_com.h"
...
# 548 "/usr/local/mysql/include/mysql_com.h"
extern "C" {
...
# 594 "/usr/local/mysql/include/mysql_com.h"
}
# 73 "/usr/local/mysql/include/mysql.h" 2
# 1 "/usr/local/mysql/include/mysql_time.h" 1
# 28 "/usr/local/mysql/include/mysql_time.h"
enum enum_mysql_timestamp_type
{
  MYSQL_TIMESTAMP_NONE= -2, MYSQL_TIMESTAMP_ERROR= -1,
  MYSQL_TIMESTAMP_DATE= 0, MYSQL_TIMESTAMP_DATETIME= 1, MYSQL_TIMESTAMP_TIME= 2
};
# 47 "/usr/local/mysql/include/mysql_time.h"
...
# 74 "/usr/local/mysql/include/mysql.h" 2

# 1 "/usr/local/mysql/include/my_list.h" 1
# 20 "/usr/local/mysql/include/my_list.h"
extern "C" {
...
# 76 "/usr/local/mysql/include/mysql.h" 2

extern unsigned int mysql_port;
extern char *mysql_unix_port;
# 94 "/usr/local/mysql/include/mysql.h"
...
# 1 "/usr/local/mysql/include/typelib.h" 1
# 20 "/usr/local/mysql/include/typelib.h"
# 1 "/usr/local/mysql/include/my_alloc.h" 1
# 27 "/usr/local/mysql/include/my_alloc.h"
extern "C" {
...
# 21 "/usr/local/mysql/include/typelib.h" 2
...
extern int find_type_or_exit(const char *x, TYPELIB *typelib,
                             const char *option);
# 42 "/usr/local/mysql/include/typelib.h"
...
# 132 "/usr/local/mysql/include/mysql.h" 2
...
# 349 "/usr/local/mysql/include/mysql.h"
int mysql_server_init(int argc, char **argv, char **groups);
void mysql_server_end(void);
# 364 "/usr/local/mysql/include/mysql.h"
...
# 502 "/usr/local/mysql/include/mysql.h"
enum enum_mysql_stmt_state
{
  MYSQL_STMT_INIT_DONE= 1, MYSQL_STMT_PREPARE_DONE, MYSQL_STMT_EXECUTE_DONE,
  MYSQL_STMT_FETCH_DONE
};
# 572 "/usr/local/mysql/include/mysql.h"
...
# 736 "/usr/local/mysql/include/mysql.h"
}
# 190 "/home/water/server/water/libs/mysql++/installed/include/mysql++/common.h" 2
# 42 "/home/water/server/water/libs/mysql++/installed/include/mysql++/noexceptions.h" 2
...
class NoExceptions;
# 71 "/home/water/server/water/libs/mysql++/installed/include/mysql++/noexceptions.h"
...
# 119 "/home/water/server/water/libs/mysql++/installed/include/mysql++/noexceptions.h"
class NoExceptions
{
public:
...
# 11 "/home/water/server/water/libs/mysql++/installed/include/mysql++/ssqls.h" 2
# 1 "/home/water/server/water/libs/mysql++/installed/include/mysql++/sql_types.h" 1
# 35 "/home/water/server/water/libs/mysql++/installed/include/mysql++/sql_types.h"
# 1 "/home/water/server/water/libs/mysql++/installed/include/mysql++/tiny_int.h" 1
# 33 "/home/water/server/water/libs/mysql++/installed/include/mysql++/tiny_int.h"
...
# 39 "/usr/include/c++/4.8.2/iosfwd" 2 3
...
# 1 "/usr/lib/gcc/x86_64-redhat-linux/4.8.2/include/stddef.h" 1 3 4
# 353 "/usr/lib/gcc/x86_64-redhat-linux/4.8.2/include/stddef.h" 3 4
...
# 34 "/home/water/server/water/libs/mysql++/installed/include/mysql++/tiny_int.h" 2

namespace mysqlpp {
# 54 "/home/water/server/water/libs/mysql++/installed/include/mysql++/tiny_int.h"
...
# 36 "/home/water/server/water/libs/mysql++/installed/include/mysql++/sql_types.h" 2
...
namespace mysqlpp {
# 66 "/home/water/server/water/libs/mysql++/installed/include/mysql++/sql_types.h"
...
# 12 "/home/water/server/water/libs/mysql++/installed/include/mysql++/ssqls.h" 2
...
# 20 "/home/water/server/water/libs/mysql++/installed/include/mysql++/ssqls.h" 2
# 31 "/home/water/server/water/libs/mysql++/installed/include/mysql++/ssqls.h"
namespace mysqlpp {

enum sql_dummy_type { sql_dummy };
# 44 "/home/water/server/water/libs/mysql++/installed/include/mysql++/ssqls.h"
...
# 23114 "/home/water/server/water/libs/mysql++/installed/include/mysql++/ssqls.h"
}
# 8 "role_table_structure.h" 2
# 16 "role_table_structure.h"
struct RowOfRole; enum RowOfRole_enum { RowOfRole_id, RowOfRole_name, RowOfRole_account, RowOfRole_sex, RowOfRole_job ,RowOfRole_NULL }; template <class Manip> class RowOfRole_value_list { public: const RowOfRole* obj; const char* delim; Manip manip; public: RowOfRole_value_list (const RowOfRole* o, const char* d, Manip m) : obj(o), delim(d), manip(m) { } }; template <class Manip> class RowOfRole_field_list { public: const RowOfRole* obj; const char* delim; Manip manip; public: RowOfRole_field_list (const RowOfRole* o, const char* d, Manip m) : obj(o), delim(d), manip(m) { } }; template <class Manip> class RowOfRole_equal_list { public: const RowOfRole* obj; const char* delim; const char* comp; Manip manip; public: RowOfRole_equal_list (const RowOfRole* o, const char* d, const char* c, Manip m) : obj(o), delim(d), comp(c), manip(m) { } }; template <class Manip> class RowOfRole_cus_value_list { public: const RowOfRole* obj; std::vector<bool> *include; bool del_vector; const char* delim; Manip manip; public: ~RowOfRole_cus_value_list () {if (del_vector) delete include;} RowOfRole_cus_value_list (const RowOfRole* o, const char* d, Manip m, bool i1, bool i2, bool i3, bool i4, bool i5); RowOfRole_cus_value_list (const RowOfRole* o, const char* d, Manip m, RowOfRole_enum i1, RowOfRole_enum i2, RowOfRole_enum i3, RowOfRole_enum i4, RowOfRole_enum i5); RowOfRole_cus_value_list (const RowOfRole* o, const char* d, Manip m ,std::vector<bool>* i) : obj(o), include(i), del_vector(false), delim(d), manip(m) { } }; template <class Manip> class RowOfRole_cus_field_list { public: const RowOfRole* obj; std::vector<bool> *include; bool del_vector; const char* delim; Manip manip; public: ~RowOfRole_cus_field_list () {if (del_vector) delete include;} RowOfRole_cus_field_list (const RowOfRole* o, const char* d, Manip m, bool i1, bool i2, bool i3, bool i4, bool i5); RowOfRole_cus_field_list (const RowOfRole* o, const char* d, Manip m, RowOfRole_enum i1, RowOfRole_enum i2, RowOfRole_enum i3, RowOfRole_enum i4, RowOfRole_enum i5); RowOfRole_cus_field_list (const RowOfRole* o, const char* d, Manip m, std::vector<bool> *i) : obj(o), include(i), del_vector(false), delim(d), manip(m) { } }; template <class Manip> class RowOfRole_cus_equal_list { public: const RowOfRole* obj; std::vector<bool> *include; bool del_vector; const char* delim; const char* comp; Manip manip; public: ~RowOfRole_cus_equal_list () {if (del_vector) delete include;} RowOfRole_cus_equal_list (const RowOfRole* o, const char* d, const char* c, Manip m, bool i1, bool i2, bool i3, bool i4, bool i5); RowOfRole_cus_equal_list (const RowOfRole* o, const char* d, const char* c, Manip m, RowOfRole_enum i1, RowOfRole_enum i2, RowOfRole_enum i3, RowOfRole_enum i4, RowOfRole_enum i5); RowOfRole_cus_equal_list (const RowOfRole* o, const char* d, const char* c, Manip m, std::vector<bool> *i) : obj(o), include(i), del_vector(false), delim(d), comp(c), manip(m) { } }; template <mysqlpp::sql_dummy_type dummy> int sql_compare_RowOfRole(const RowOfRole&, const RowOfRole&); struct RowOfRole { mysqlpp::sql_bigint id; mysqlpp::sql_char name; mysqlpp::sql_char account; uint8_t sex; uint8_t job; RowOfRole() : table_override_(0) { } RowOfRole(const mysqlpp::Row& row); void set(const mysqlpp::Row &row); RowOfRole(const mysqlpp::sql_bigint &p1) : id (p1), table_override_(0) {} void set(const mysqlpp::sql_bigint &p1) { table_override_ = 0; id = p1; } bool operator == (const RowOfRole &other) const {return sql_compare_RowOfRole<mysqlpp::sql_dummy>(*this,other) == 0;} bool operator != (const RowOfRole &other) const {return sql_compare_RowOfRole<mysqlpp::sql_dummy>(*this,other) != 0;} bool operator > (const RowOfRole &other) const {return sql_compare_RowOfRole<mysqlpp::sql_dummy>(*this,other) > 0;} bool operator < (const RowOfRole &other) const {return sql_compare_RowOfRole<mysqlpp::sql_dummy>(*this,other) < 0;} bool operator >= (const RowOfRole &other) const {return sql_compare_RowOfRole<mysqlpp::sql_dummy>(*this,other) >= 0;} bool operator <= (const RowOfRole &other) const {return sql_compare_RowOfRole<mysqlpp::sql_dummy>(*this,other) <= 0;} int cmp (const RowOfRole &other) const {return sql_compare_RowOfRole<mysqlpp::sql_dummy>(*this,other);} int compare (const RowOfRole &other) const {return sql_compare_RowOfRole<mysqlpp::sql_dummy>(*this,other);} void set(const mysqlpp::sql_bigint &p1, const mysqlpp::sql_char &p2, const mysqlpp::sql_char &p3, const uint8_t &p4, const uint8_t &p5) { table_override_ = 0; id = p1; name = p2; account = p3; sex = p4; job = p5; } RowOfRole(const mysqlpp::sql_bigint &p1, const mysqlpp::sql_char &p2, const mysqlpp::sql_char &p3, const uint8_t &p4, const uint8_t &p5) : id (p1), name (p2), account (p3), sex (p4), job (p5), table_override_(0) {} static const char* names[]; static void table(const char* t) { table_ = t; } const char* table() const { return table_override_ ? table_override_ : RowOfRole::table_; } void instance_table(const char* t) { table_override_ = t; } RowOfRole_value_list<mysqlpp::quote_type0> value_list() const { return value_list(",", mysqlpp::quote);} RowOfRole_value_list<mysqlpp::quote_type0> value_list(const char* d) const { return value_list(d, mysqlpp::quote);} template <class Manip> RowOfRole_value_list<Manip> value_list(const char* d, Manip m) const; RowOfRole_field_list<mysqlpp::do_nothing_type0> field_list() const { return field_list(",", mysqlpp::do_nothing);} RowOfRole_field_list<mysqlpp::do_nothing_type0> field_list(const char* d) const { return field_list(d, mysqlpp::do_nothing);} template <class Manip> RowOfRole_field_list<Manip> field_list(const char* d, Manip m) const; RowOfRole_equal_list<mysqlpp::quote_type0> equal_list(const char* d = ",", const char* c = " = ") const { return equal_list(d, c, mysqlpp::quote); } template <class Manip> RowOfRole_equal_list<Manip> equal_list(const char* d, const char* c, Manip m) const; RowOfRole_cus_value_list<mysqlpp::quote_type0> value_list(bool i1, bool i2 = false, bool i3 = false, bool i4 = false, bool i5 = false) const { return value_list(",", mysqlpp::quote, i1, i2, i3, i4, i5); } RowOfRole_cus_value_list<mysqlpp::quote_type0> value_list(RowOfRole_enum i1, RowOfRole_enum i2 = RowOfRole_NULL, RowOfRole_enum i3 = RowOfRole_NULL, RowOfRole_enum i4 = RowOfRole_NULL, RowOfRole_enum i5 = RowOfRole_NULL) const { return value_list(",", mysqlpp::quote, i1, i2, i3, i4, i5); } RowOfRole_cus_value_list<mysqlpp::quote_type0> value_list(std::vector<bool> *i) const { return value_list(",", mysqlpp::quote, i); } RowOfRole_cus_value_list<mysqlpp::quote_type0> value_list(mysqlpp::sql_cmp_type sc) const { return value_list(",", mysqlpp::quote, sc); } RowOfRole_cus_value_list<mysqlpp::quote_type0> value_list(const char* d, bool i1, bool i2 = false, bool i3 = false, bool i4 = false, bool i5 = false) const { return value_list(d, mysqlpp::quote, i1, i2, i3, i4, i5); } RowOfRole_cus_value_list<mysqlpp::quote_type0> value_list(const char* d, RowOfRole_enum i1, RowOfRole_enum i2 = RowOfRole_NULL, RowOfRole_enum i3 = RowOfRole_NULL, RowOfRole_enum i4 = RowOfRole_NULL, RowOfRole_enum i5 = RowOfRole_NULL) const { return value_list(d, mysqlpp::quote, i1, i2, i3, i4, i5); } RowOfRole_cus_value_list<mysqlpp::quote_type0> value_list(const char* d, std::vector<bool> *i) const { return value_list(d, mysqlpp::quote, i); } RowOfRole_cus_value_list<mysqlpp::quote_type0> value_list(const char* d, mysqlpp::sql_cmp_type sc) const { return value_list(d, mysqlpp::quote, sc); } template <class Manip> RowOfRole_cus_value_list<Manip> value_list(const char* d, Manip m, bool i1, bool i2 = false, bool i3 = false, bool i4 = false, bool i5 = false) const; template <class Manip> RowOfRole_cus_value_list<Manip> value_list(const char* d, Manip m, RowOfRole_enum i1, RowOfRole_enum i2 = RowOfRole_NULL, RowOfRole_enum i3 = RowOfRole_NULL, RowOfRole_enum i4 = RowOfRole_NULL, RowOfRole_enum i5 = RowOfRole_NULL) const; template <class Manip> RowOfRole_cus_value_list<Manip> value_list(const char* d, Manip m, std::vector<bool>* i) const; template <class Manip> RowOfRole_cus_value_list<Manip> value_list(const char* d, Manip m, mysqlpp::sql_cmp_type sc) const; RowOfRole_cus_field_list<mysqlpp::do_nothing_type0> field_list(bool i1, bool i2 = false, bool i3 = false, bool i4 = false, bool i5 = false) const { return field_list(",", mysqlpp::do_nothing, i1, i2, i3, i4, i5); } RowOfRole_cus_field_list<mysqlpp::do_nothing_type0> field_list(RowOfRole_enum i1, RowOfRole_enum i2 = RowOfRole_NULL, RowOfRole_enum i3 = RowOfRole_NULL, RowOfRole_enum i4 = RowOfRole_NULL, RowOfRole_enum i5 = RowOfRole_NULL) const { return field_list(",", mysqlpp::do_nothing, i1, i2, i3, i4, i5); } RowOfRole_cus_field_list<mysqlpp::do_nothing_type0> field_list(std::vector<bool> *i) const { return field_list(",", mysqlpp::do_nothing, i); } RowOfRole_cus_field_list<mysqlpp::do_nothing_type0> field_list(mysqlpp::sql_cmp_type sc) const { return field_list(",", mysqlpp::do_nothing, sc); } RowOfRole_cus_field_list<mysqlpp::do_nothing_type0> field_list(const char* d, bool i1, bool i2 = false, bool i3 = false, bool i4 = false, bool i5 = false) const { return field_list(d, mysqlpp::do_nothing, i1, i2, i3, i4, i5); } RowOfRole_cus_field_list<mysqlpp::do_nothing_type0> field_list(const char* d, RowOfRole_enum i1, RowOfRole_enum i2 = RowOfRole_NULL, RowOfRole_enum i3 = RowOfRole_NULL, RowOfRole_enum i4 = RowOfRole_NULL, RowOfRole_enum i5 = RowOfRole_NULL) const { return field_list(d, mysqlpp::do_nothing, i1, i2, i3, i4, i5); } RowOfRole_cus_field_list<mysqlpp::do_nothing_type0> field_list(const char* d, std::vector<bool>* i) const { return field_list(d, mysqlpp::do_nothing, i); } RowOfRole_cus_field_list<mysqlpp::do_nothing_type0> field_list(const char* d, mysqlpp::sql_cmp_type sc) const { return field_list(d, mysqlpp::do_nothing, sc); } template <class Manip> RowOfRole_cus_field_list<Manip> field_list(const char* d, Manip m, bool i1, bool i2 = false, bool i3 = false, bool i4 = false, bool i5 = false) const; template <class Manip> RowOfRole_cus_field_list<Manip> field_list(const char* d, Manip m, RowOfRole_enum i1, RowOfRole_enum i2 = RowOfRole_NULL, RowOfRole_enum i3 = RowOfRole_NULL, RowOfRole_enum i4 = RowOfRole_NULL, RowOfRole_enum i5 = RowOfRole_NULL) const; template <class Manip> RowOfRole_cus_field_list<Manip> field_list(const char* d, Manip m, std::vector<bool> *i) const; template <class Manip> RowOfRole_cus_field_list<Manip> field_list(const char* d, Manip m, mysqlpp::sql_cmp_type sc) const; RowOfRole_cus_equal_list<mysqlpp::quote_type0> equal_list(bool i1, bool i2 = false, bool i3 = false, bool i4 = false, bool i5 = false) const { return equal_list(",", " = ", mysqlpp::quote, i1, i2, i3, i4, i5); } RowOfRole_cus_equal_list<mysqlpp::quote_type0> equal_list(RowOfRole_enum i1, RowOfRole_enum i2 = RowOfRole_NULL, RowOfRole_enum i3 = RowOfRole_NULL, RowOfRole_enum i4 = RowOfRole_NULL, RowOfRole_enum i5 = RowOfRole_NULL) const { return equal_list(",", " = ", mysqlpp::quote, i1, i2, i3, i4, i5); } RowOfRole_cus_equal_list<mysqlpp::quote_type0> equal_list(std::vector<bool>* i) const { return equal_list(",", " = ", mysqlpp::quote, i); } RowOfRole_cus_equal_list<mysqlpp::quote_type0> equal_list(mysqlpp::sql_cmp_type sc) const { return equal_list(",", " = ", mysqlpp::quote, sc); } RowOfRole_cus_equal_list<mysqlpp::quote_type0> equal_list(const char* d, bool i1, bool i2 = false, bool i3 = false, bool i4 = false, bool i5 = false) const { return equal_list(d, " = ", mysqlpp::quote, i1, i2, i3, i4, i5); } RowOfRole_cus_equal_list<mysqlpp::quote_type0> equal_list(const char* d, RowOfRole_enum i1, RowOfRole_enum i2 = RowOfRole_NULL, RowOfRole_enum i3 = RowOfRole_NULL, RowOfRole_enum i4 = RowOfRole_NULL, RowOfRole_enum i5 = RowOfRole_NULL) const { return equal_list(d, " = ", mysqlpp::quote, i1, i2, i3, i4, i5); } RowOfRole_cus_equal_list<mysqlpp::quote_type0> equal_list(const char* d, std::vector<bool> *i) const { return equal_list(d, " = ", mysqlpp::quote, i); } RowOfRole_cus_equal_list<mysqlpp::quote_type0> equal_list(const char* d, mysqlpp::sql_cmp_type sc) const { return equal_list(d, " = ", mysqlpp::quote, sc); } RowOfRole_cus_equal_list<mysqlpp::quote_type0> equal_list(const char* d, const char* c, bool i1, bool i2 = false, bool i3 = false, bool i4 = false, bool i5 = false) const { return equal_list(d, c, mysqlpp::quote, i1, i2, i3, i4, i5); } RowOfRole_cus_equal_list<mysqlpp::quote_type0> equal_list(const char* d, const char* c, RowOfRole_enum i1, RowOfRole_enum i2 = RowOfRole_NULL, RowOfRole_enum i3 = RowOfRole_NULL, RowOfRole_enum i4 = RowOfRole_NULL, RowOfRole_enum i5 = RowOfRole_NULL) const { return equal_list(d, c, mysqlpp::quote, i1, i2, i3, i4, i5); } RowOfRole_cus_equal_list<mysqlpp::quote_type0> equal_list(const char* d, const char* c, std::vector<bool> *i) const { return equal_list(d, c, mysqlpp::quote, i); } RowOfRole_cus_equal_list<mysqlpp::quote_type0> equal_list(const char* d, const char* c, mysqlpp::sql_cmp_type sc) const { return equal_list(d, c, mysqlpp::quote, sc); } template <class Manip> RowOfRole_cus_equal_list<Manip> equal_list(const char* d, const char* c, Manip m, bool i1, bool i2 = false, bool i3 = false, bool i4 = false, bool i5 = false) const; template <class Manip> RowOfRole_cus_equal_list<Manip> equal_list(const char* d, const char* c, Manip m, RowOfRole_enum i1, RowOfRole_enum i2 = RowOfRole_NULL, RowOfRole_enum i3 = RowOfRole_NULL, RowOfRole_enum i4 = RowOfRole_NULL, RowOfRole_enum i5 = RowOfRole_NULL) const; template <class Manip> RowOfRole_cus_equal_list<Manip> equal_list(const char* d, const char* c, Manip m, std::vector<bool> *i) const; template <class Manip> RowOfRole_cus_equal_list<Manip> equal_list(const char* d, const char* c, Manip m, mysqlpp::sql_cmp_type sc) const; private: static const char* table_; const char* table_override_; }; const char* RowOfRole::names[] = { "id" , "name" , "account" , "sex" , "job" }; const char* RowOfRole::table_ = "RowOfRole"; template <class Manip> RowOfRole_cus_value_list<Manip>::RowOfRole_cus_value_list (const RowOfRole* o, const char* d, Manip m, bool i1, bool i2, bool i3, bool i4, bool i5) { delim = d; manip = m; del_vector = true; obj = o; include = new std::vector<bool>(5, false); if (i1) (*include)[0]=true; if (i2) (*include)[1]=true; if (i3) (*include)[2]=true; if (i4) (*include)[3]=true; if (i5) (*include)[4]=true; } template <class Manip> RowOfRole_cus_value_list<Manip>::RowOfRole_cus_value_list (const RowOfRole* o, const char* d, Manip m, RowOfRole_enum i1, RowOfRole_enum i2, RowOfRole_enum i3, RowOfRole_enum i4, RowOfRole_enum i5) { delim = d; manip = m; del_vector = true; obj = o; include = new std::vector<bool>(5, false); if (i1 == RowOfRole_NULL) return; (*include)[i1]=true; if (i2 == RowOfRole_NULL) return; (*include)[i2]=true; if (i3 == RowOfRole_NULL) return; (*include)[i3]=true; if (i4 == RowOfRole_NULL) return; (*include)[i4]=true; if (i5 == RowOfRole_NULL) return; (*include)[i5]=true; } template <class Manip> RowOfRole_cus_field_list<Manip>::RowOfRole_cus_field_list (const RowOfRole* o, const char* d, Manip m, bool i1, bool i2, bool i3, bool i4, bool i5) { delim = d; manip = m; del_vector = true; obj = o; include = new std::vector<bool>(5, false); if (i1) (*include)[0]=true; if (i2) (*include)[1]=true; if (i3) (*include)[2]=true; if (i4) (*include)[3]=true; if (i5) (*include)[4]=true; } template <class Manip> RowOfRole_cus_field_list<Manip>::RowOfRole_cus_field_list (const RowOfRole* o, const char* d, Manip m, RowOfRole_enum i1, RowOfRole_enum i2, RowOfRole_enum i3, RowOfRole_enum i4, RowOfRole_enum i5) { delim = d; manip = m; del_vector = true; obj = o; include = new std::vector<bool>(5, false); if (i1 == RowOfRole_NULL) return; (*include)[i1]=true; if (i2 == RowOfRole_NULL) return; (*include)[i2]=true; if (i3 == RowOfRole_NULL) return; (*include)[i3]=true; if (i4 == RowOfRole_NULL) return; (*include)[i4]=true; if (i5 == RowOfRole_NULL) return; (*include)[i5]=true; } template <class Manip> RowOfRole_cus_equal_list<Manip>::RowOfRole_cus_equal_list (const RowOfRole* o, const char* d, const char* c, Manip m, bool i1, bool i2, bool i3, bool i4, bool i5) { delim = d; comp = c; manip = m; del_vector = true; obj = o; include = new std::vector<bool>(5, false); if (i1) (*include)[0]=true; if (i2) (*include)[1]=true; if (i3) (*include)[2]=true; if (i4) (*include)[3]=true; if (i5) (*include)[4]=true; } template <class Manip> RowOfRole_cus_equal_list<Manip>::RowOfRole_cus_equal_list (const RowOfRole* o, const char* d, const char* c, Manip m, RowOfRole_enum i1, RowOfRole_enum i2, RowOfRole_enum i3, RowOfRole_enum i4, RowOfRole_enum i5) { delim = d; comp = c; manip = m; del_vector = true; obj = o; include = new std::vector<bool>(5, false); if (i1 == RowOfRole_NULL) return; (*include)[i1]=true; if (i2 == RowOfRole_NULL) return; (*include)[i2]=true; if (i3 == RowOfRole_NULL) return; (*include)[i3]=true; if (i4 == RowOfRole_NULL) return; (*include)[i4]=true; if (i5 == RowOfRole_NULL) return; (*include)[i5]=true; } template <class Manip> std::ostream& operator <<(std::ostream& s, const RowOfRole_value_list<Manip>& obj) { s << obj.manip << obj.obj->id << obj.delim; s << obj.manip << obj.obj->name << obj.delim; s << obj.manip << obj.obj->account << obj.delim; s << obj.manip << obj.obj->sex << obj.delim; s << obj.manip << obj.obj->job; return s; } template <class Manip> std::ostream& operator <<(std::ostream& s, const RowOfRole_field_list<Manip>& obj) { s << obj.manip << '`' << obj.obj->names[0] << '`' << obj.delim; s << obj.manip << '`' << obj.obj->names[1] << '`' << obj.delim; s << obj.manip << '`' << obj.obj->names[2] << '`' << obj.delim; s << obj.manip << '`' << obj.obj->names[3] << '`' << obj.delim; s << obj.manip << '`' << obj.obj->names[4] << '`'; return s; } template <class Manip> std::ostream& operator <<(std::ostream& s, const RowOfRole_equal_list<Manip>& obj) { s << '`' << obj.obj->names[0] << '`' << obj.comp << obj.manip << obj.obj->id << obj.delim; s << '`' << obj.obj->names[1] << '`' << obj.comp << obj.manip << obj.obj->name << obj.delim; s << '`' << obj.obj->names[2] << '`' << obj.comp << obj.manip << obj.obj->account << obj.delim; s << '`' << obj.obj->names[3] << '`' << obj.comp << obj.manip << obj.obj->sex << obj.delim; s << '`' << obj.obj->names[4] << '`' << obj.comp << obj.manip << obj.obj->job; return s; } template <class Manip> std::ostream& operator <<(std::ostream& s, const RowOfRole_cus_value_list<Manip>& obj) { bool before = false; if ((*obj.include)[0]) { s << obj.manip << obj.obj->id; before = true; } if ((*obj.include)[1]) { if (before) s << obj.delim; s << obj.manip << obj.obj->name; before = true; } if ((*obj.include)[2]) { if (before) s << obj.delim; s << obj.manip << obj.obj->account; before = true; } if ((*obj.include)[3]) { if (before) s << obj.delim; s << obj.manip << obj.obj->sex; before = true; } if ((*obj.include)[4]) { if (before) s << obj.delim; s << obj.manip << obj.obj->job; } return s; } template <class Manip> std::ostream& operator <<(std::ostream& s, const RowOfRole_cus_field_list<Manip>& obj) { bool before = false; if ((*obj.include)[0]) { s << obj.manip << '`' << obj.obj->names[0] << '`'; before = true; } if ((*obj.include)[1]) { if (before) s << obj.delim; s << obj.manip << '`' << obj.obj->names[1] << '`'; before = true; } if ((*obj.include)[2]) { if (before) s << obj.delim; s << obj.manip << '`' << obj.obj->names[2] << '`'; before = true; } if ((*obj.include)[3]) { if (before) s << obj.delim; s << obj.manip << '`' << obj.obj->names[3] << '`'; before = true; } if ((*obj.include)[4]) { if (before) s << obj.delim; s << obj.manip << '`' << obj.obj->names[4] << '`'; } return s; } template <class Manip> std::ostream& operator <<(std::ostream& s, const RowOfRole_cus_equal_list<Manip>& obj) { bool before = false; if ((*obj.include)[0]) { s << '`' << obj.obj->names[0] << '`' << obj.comp << obj.manip << obj.obj->id; before = true; } if ((*obj.include)[1]) { if (before) s << obj.delim; s << '`' << obj.obj->names[1] << '`' << obj.comp << obj.manip << obj.obj->name; before = true; } if ((*obj.include)[2]) { if (before) s << obj.delim; s << '`' << obj.obj->names[2] << '`' << obj.comp << obj.manip << obj.obj->account; before = true; } if ((*obj.include)[3]) { if (before) s << obj.delim; s << '`' << obj.obj->names[3] << '`' << obj.comp << obj.manip << obj.obj->sex; before = true; } if ((*obj.include)[4]) { if (before) s << obj.delim; s << '`' << obj.obj->names[4] << '`' << obj.comp << obj.manip << obj.obj->job; } return s; } template <class Manip> inline RowOfRole_value_list<Manip> RowOfRole::value_list(const char* d, Manip m) const { return RowOfRole_value_list<Manip> (this, d, m); } template <class Manip> inline RowOfRole_field_list<Manip> RowOfRole::field_list(const char* d, Manip m) const { return RowOfRole_field_list<Manip> (this, d, m); } template <class Manip> inline RowOfRole_equal_list<Manip> RowOfRole::equal_list(const char* d, const char* c, Manip m) const { return RowOfRole_equal_list<Manip> (this, d, c, m); } template <class Manip> inline RowOfRole_cus_value_list<Manip> RowOfRole::value_list(const char* d, Manip m, bool i1, bool i2, bool i3, bool i4, bool i5) const { return RowOfRole_cus_value_list<Manip> (this, d, m, i1, i2, i3, i4, i5); } template <class Manip> inline RowOfRole_cus_field_list<Manip> RowOfRole::field_list(const char* d, Manip m, bool i1, bool i2, bool i3, bool i4, bool i5) const { return RowOfRole_cus_field_list<Manip> (this, d, m, i1, i2, i3, i4, i5); } template <class Manip> inline RowOfRole_cus_equal_list<Manip> RowOfRole::equal_list(const char* d, const char* c, Manip m, bool i1, bool i2, bool i3, bool i4, bool i5) const { return RowOfRole_cus_equal_list<Manip> (this, d, c, m, i1, i2, i3, i4, i5); } template <class Manip> inline RowOfRole_cus_value_list<Manip> RowOfRole::value_list(const char* d, Manip m, RowOfRole_enum i1, RowOfRole_enum i2, RowOfRole_enum i3, RowOfRole_enum i4, RowOfRole_enum i5) const { return RowOfRole_cus_value_list<Manip> (this, d, m, i1, i2, i3, i4, i5); } template <class Manip> inline RowOfRole_cus_field_list<Manip> RowOfRole::field_list(const char* d, Manip m, RowOfRole_enum i1, RowOfRole_enum i2, RowOfRole_enum i3, RowOfRole_enum i4, RowOfRole_enum i5) const { return RowOfRole_cus_field_list<Manip> (this, d, m, i1, i2, i3, i4, i5); } template <class Manip> inline RowOfRole_cus_equal_list<Manip> RowOfRole::equal_list(const char* d, const char* c, Manip m, RowOfRole_enum i1, RowOfRole_enum i2, RowOfRole_enum i3, RowOfRole_enum i4, RowOfRole_enum i5) const { return RowOfRole_cus_equal_list<Manip> (this, d, c, m, i1, i2, i3, i4, i5); } template <class Manip> inline RowOfRole_cus_value_list<Manip> RowOfRole::value_list(const char* d, Manip m, std::vector<bool> *i) const { return RowOfRole_cus_value_list<Manip> (this, d, m, i); } template <class Manip> inline RowOfRole_cus_field_list<Manip> RowOfRole::field_list(const char* d, Manip m, std::vector<bool> *i) const { return RowOfRole_cus_field_list<Manip> (this, d, m, i); } template <class Manip> inline RowOfRole_cus_equal_list<Manip> RowOfRole::equal_list(const char* d, const char* c, Manip m, std::vector<bool> *i) const { return RowOfRole_cus_equal_list<Manip> (this, d, c, m, i); } template <class Manip> inline RowOfRole_cus_value_list<Manip> RowOfRole::value_list(const char* d, Manip m, mysqlpp::sql_cmp_type ) const { return value_list(d, m, true); } template <class Manip> inline RowOfRole_cus_field_list<Manip> RowOfRole::field_list(const char* d, Manip m, mysqlpp::sql_cmp_type ) const { return field_list(d, m, true); } template <class Manip> inline RowOfRole_cus_equal_list<Manip> RowOfRole::equal_list(const char* d, const char* c, Manip m, mysqlpp::sql_cmp_type ) const { return equal_list(d, c, m, true); } template <mysqlpp::sql_dummy_type dummy> void populate_RowOfRole(RowOfRole *s, const mysqlpp::Row &row) { mysqlpp::NoExceptions ignore_schema_mismatches(row); s->id = row["id"].conv(mysqlpp::sql_bigint()); s->name = row["name"].conv(mysqlpp::sql_char()); s->account = row["account"].conv(mysqlpp::sql_char()); s->sex = row["sex"].conv(uint8_t()); s->job = row["job"].conv(uint8_t()); } inline RowOfRole::RowOfRole(const mysqlpp::Row& row) : table_override_(0) { populate_RowOfRole<mysqlpp::sql_dummy>(this, row); } inline void RowOfRole::set(const mysqlpp::Row& row) { table_override_ = 0; populate_RowOfRole<mysqlpp::sql_dummy>(this, row); } template <mysqlpp::sql_dummy_type dummy> int sql_compare_RowOfRole(const RowOfRole &x, const RowOfRole &y) { return mysqlpp::sql_cmp(x.id , y.id ); } template <mysqlpp::sql_dummy_type dummy> int compare (const RowOfRole &x, const RowOfRole &y) { return mysqlpp::sql_cmp(x.id , y.id ); }
# 4 "role_table_structure.cpp" 2
